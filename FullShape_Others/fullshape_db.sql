CREATE DATABASE  IF NOT EXISTS `fullshape_db` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `fullshape_db`;
...
CREATE TABLE `productCart` (
  ...
  CONSTRAINT `productId` FOREIGN KEY (`productId`) REFERENCES `products` (`productId`) ON DELETE CASCADE,
  CONSTRAINT `shoppingCartId` FOREIGN KEY (`shoppingCartId`) REFERENCES `shoppingCart` (`shoppingCartId`) ON DELETE CASCADE
...
CREATE TABLE `products` (
  ...
  CONSTRAINT `categoryId` FOREIGN KEY (`productCategoryId`) REFERENCES `productCategories` (`categoryId`) ON DELETE CASCADE,
  CONSTRAINT `colorid` FOREIGN KEY (`productColorId`) REFERENCES `productColors` (`colorId`) ON DELETE CASCADE,
  CONSTRAINT `sizeId` FOREIGN KEY (`productSizeId`) REFERENCES `productSizes` (`sizeId`) ON DELETE CASCADE,
  CONSTRAINT `statusId` FOREIGN KEY (`productStatusId`) REFERENCES `productStatus` (`statusId`) ON DELETE CASCADE
...
-- Dump completed on 2022-08-09 23:08:50
